define('confluence-collaborative-editor-plugin/synchrony-editor', [
    ...
    exports.init = function () {
        if (EditorSupport.isCollaborativeContentType()) {
            var collabEditingEnabled = makeInitPromise('rte-quick-edit-init rte-collaborative-content-ready', true);
            var editTriggered = makeInitPromise('rte-quick-edit-init rte-collaborative-content-ready rte-collab-editor-loaded', false);

            var contentLoaded = makeInitPromise('rte-collaborative-content-ready', false, Content.getContent);

            var collabEditorLoaded = makeInitPromise('rte-collab-editor-loaded', false, AJS.Rte.getEditor);
            collabEditorLoaded = makeInitPromise('rte-begin-collab-editing', false, AJS.Rte.getEditor, isSlowEdit, collabEditorLoaded);
    ...
    exports.getSynchronisedEditorContent = function () {
        ...
        logger.logError('Synchrony hasn\'t acked any data, can\'t fetch draft data');
        return null;
    };
