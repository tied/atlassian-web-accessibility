define("confluence-space-ia/avatar-picker/client-file-iframe-uploader", [
    "jquery",
    "underscore",
    "confluence-space-ia/avatar-picker/client-file-handler"
], function($, _, ClientFileHandler) {
    ...
    ClientFileIframeUploader.prototype.defaults = $.extend({}, ClientFileHandler.prototype.defaults, {
        uploadURL: AJS.Meta.get('context-path') + '/rest/ia/1.0/space/defaultLogo',
