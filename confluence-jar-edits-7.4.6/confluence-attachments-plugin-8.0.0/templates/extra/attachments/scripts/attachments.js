    ...
    var attachments = {
        ...
        initUploadForm : function(uploadForm) {
            ...
            uploadIframe.load(function() {
                ...
                var errorBoxInSomeHtml = iframeBody.find("div.aui-message.error,div.aui-message.aui-message-error");
                ...
                if (errorBoxInSomeHtml.length > 0 && $.trim(errorBoxInSomeHtml.html()).length > 0) {
                    ...
                    setTimeout(function(){$(".aui-message.error,.aui-message.aui-message-error").remove();}, 3000);
...
//                                });
//                            setTimeout(function(){$(".aui-message.success,.aui-message.aui-message-success").remove();}, 3000);
                            waitIcon.css("visibility", "hidden");
                            submitButton.removeClass("hidden");
