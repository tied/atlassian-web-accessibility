/**
 * @module confluence-editor/tinymce3/plugins/searchreplace/searchreplace
 */
define('confluence-editor/tinymce3/plugins/searchreplace/searchreplace', [
    ...
    SearchManager.impl = function(uiManager, mManager) {
        ...
        var replaceAll = function(fText, replacementText) {
            ...
            if (replacedCount === 0) {
                EditorNotification.notify('info', ed.getLang('searchreplace_dlg.notfound'));
            } else if (replacedCount === 1) {
                EditorNotification.notify('success', ed.getLang('searchreplace_dlg.allreplacedsingular'));
            } else if (replacedCount > 1) {
                var msg = ed.getLang('searchreplace_dlg.allreplacedplural');
                EditorNotification.notify('success', msg.replace('{0}', replacedCount));
            }
    ...
    SearchManager.implIE = function(uiManager) {
        ...
        var replaceAll = function(fText, replacementText) {
            ...
            if (replacedCount === 0) {
                ...
                msg = ed.getLang('searchreplace_dlg.allreplacedplural');
                EditorNotification.notify('success', msg.replace('{0}', replacedCount));
            }
        ...
        var removeMarkOnSaveListener = function() {
            clearMarks();
        };
    ...
    SearchManager.UI = function(toolbarId, initialFindText, initialReplaceText) {
        ...
        /**
         * @return {object} the input field as a jQuery wrapped object.
         */
        ...
        /**
         * @param {boolean} enabled if true then enable the find button
         */
        ...
        /**
         * @return {object} the replace button as a jQuery wrapped object.
         */
        ...
        /**
         * @param {boolean} enabled if true then enable the replace button and shortcut; otherwise disable
         */
        ...
        /**
         * @param {boolean} enabled if true then enable the replace all button and shortcut; otherwise disable
         */
    ...
    SearchManager.MarkManager = function() {
         ...
         * editor content and remove the mark.
         */
        var contentChangeListener = function() {
         ...
         *
         * @param {boolean} select if true then the browser selection will be set immediately after the mark. if false
         * then the original browser selection will be maintained.
         */
         ...
         *
         * @param {object} mark a jQuery wrapped mark element
         * @param {boolean} select if true then the browser selection will be set to the content of the mark
         * @return {boolean} true if mark removed or false otherwise
         */
         ...
         *
         * @param {string} text the text to replace the current mark with
         * @return {boolean} the true if replacement occurred or false otherwise.
         */
         ...
         *
         * @param {string} text the text to set as the content of the current mark
         * @return {object} the DOM Node representing the new text added or null if no current mark
         */
         ...
         * Register Listeners to handle the clean up of marks a necessary
         *
         * @param {boolean} unmarkable if true then no mark element was created.
         */
