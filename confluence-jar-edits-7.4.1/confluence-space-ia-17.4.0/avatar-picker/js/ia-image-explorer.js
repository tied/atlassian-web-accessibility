define("confluence-space-ia/avatar-picker/image-explorer", [
    "jquery",
    "underscore"
], function($, _) {
    ...
    ImageExplorer.prototype.showError = function(title, contents) {
        ...
        var $errorMessage = $(aui.message.error({
                titleContent: title,
                content: contents || '',
                closeable: true
            }));
    ...
    ImageExplorer.prototype._removeError = function(){
        // We need to remove error for old AUI and AUI 8
        this.$imageView.find('.aui-message.aui-message-error').remove();
