 ...
 *
 * @module confluence-quick-edit/handlers/comment/edit
 */
define('confluence-quick-edit/handlers/comment/edit', [
    ...
    function handleTransition($comment) {
        ...
        var template = $(ConfluenceTemplates.Comments.displayEditEditorContainer(params));
    ...
    function fetchCommentContent(commentId) {
        ...
        $.ajax({
            url: contextPath() + '/rest/api/content/' + commentId + '?expand=body.editor',
            cache: false
        }).done(function(data) {
    ...
    QuickEdit.register(editHandler);

    return {
        cancelComment: function() {
            logger.log('\'AJS.Confluence.QuickEdit.QuickComment.Edit.cancelComment\' is deprecated in 5.7, consider using \'AJS.Confluence.QuickEdit.QuickComment.cancelComment\' instead.');
