/**
 * @module confluence-drag-and-drop/insert-dialog-upload-controller
 */
...
require('confluence/module-exporter').exportModuleAsGlobal('confluence-drag-and-drop/insert-dialog-upload-controller', 'Confluence.DragAndDrop.UploadClientController');
