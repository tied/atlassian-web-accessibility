AJS.$(function() {
    ...
    $('#space-favourite-remove').on('click', function() {
        ...
        $('#space-favourite-add').show();
        $('#space-favourite-remove').hide();
    });

    $('#space-favourite-add').on('click', function() {
        toggleFavouriteSpace("add");

        $('#space-favourite-remove').show();
        $('#space-favourite-add').hide();
    });
    ...
    function toggleFavouriteSpace(state) {
        ...
        $.ajax({
            ...
            if (state === "add") {
                $('#space-favourite-add').prop("data-favourited", "true");
            } else {
                $('#space-favourite-add').prop("data-favourited", "false");
            }
        });
    ...
    function enterConfigureMode() {
        ...
        $throbber.height($('.acs-nav-sections').height());
        $secondaryNav.hide();
        $('.acs-nav-sections').replaceWith($throbber);
