/* global Raphael: true */
/*Create a custom Inline Dialog from InlineDialog of AUI 5.5. Because I want to have a left arrow of InlineDialog. It's available in AUI 5.5 while Confluence, JIRA and Bamboo are using 5.4*/
(function ($) {
    /**
     ...
     */
    AJS.CustomInlineDialog = AJS.CustomInlineDialog || function (items, identifier, url, options) {
            options = options || [];
            ...
            var opts = $.extend(false, AJS.CustomInlineDialog.opts, options);
            if (opts.gravity === 'w') {
            ...
            var showPopup = function () {
                ...
                showTimer = setTimeout(function () {
                    ...
                    AJS.CustomInlineDialog.current = getHash();
