 ...
 *
 * @module atlassian-tinymce/plugins/template/editor_plugin_src
 */
define('atlassian-tinymce/plugins/template/editor_plugin_src', [
    'tinymce'
], function(
    tinymce
) {
    ...
    return {
        ...
        _replaceVals : function(e) {
            ...
            var vl = this.editor.getParam('template_replace_values');
...
require('confluence/module-exporter').safeRequire('atlassian-tinymce/plugins/template/editor_plugin_src', function(TemplatePlugin) {
    var tinymce = require('tinymce');

    tinymce.create('tinymce.plugins.TemplatePlugin', TemplatePlugin);
